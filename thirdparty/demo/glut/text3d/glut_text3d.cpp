...
//     	gluTessCallback(tobj, GLU_BEGIN, (PF_CALLBACK)glBegin);
//     	gluTessCallback(tobj, GLU_VERTEX, (PF_CALLBACK)glVertex3fv);
//     	gluTessCallback(tobj, GLU_END, (PF_CALLBACK)glEnd);
    }
